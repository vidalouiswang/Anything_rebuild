  ...
  */
    class GetIcon
    {
        ...
        public static unsafe Region GetRegion(Bitmap bckImage)
        {
            ...
            try
            {
                bckdata = bckImage.LockBits(new System.Drawing.Rectangle(0, 0, w, h), ImageLockMode.ReadOnly, System.Drawing.Imaging.PixelFormat.Format32bppArgb);
        ...
        public static Bitmap GetPart(Bitmap bit)
        {
            ...
            System.Drawing.Rectangle rect = new System.Drawing.Rectangle(0, 0, count, count);
        ...
        public static ImageSource GetIconIS(String path)
        {
            ...
            //转换
            ImageSource IS = System.Windows.Interop.Imaging.CreateBitmapSourceFromHIcon(icon.Handle,
